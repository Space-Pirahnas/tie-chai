      ...
      <div className="matchCard" style={{ backgroundImage: "url(styles/creampaper.png)" }}>
        ...
        <div className="matchInfo">
          ...
          <div className="matchInterests">
            {this.props.match ? this.props.match.Interests.split('-').sort((a, b) => userInterests.indexOf(a) > -1 ? -1 : 1).slice(0,6).map((interest, i) => <div className={userInterests.indexOf(interest) > -1 ? "matching_interests" : "interests"} key={i}>{interest}</div>) : null}
          </div>
        </div>
